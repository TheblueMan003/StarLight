...
execute if score default.utils.process_manager.t_running tbms.var matches 1 run function default:zzz_sl_block/327
execute if score default.utils.process_manager.t_running tbms.var matches 0 if score default.utils.process_manager.show._0 tbms.var matches 0 run function default:zzz_sl_block/328
execute if score default.utils.process_manager.show._0 tbms.var matches 0 run function default:zzz_sl_block/329
