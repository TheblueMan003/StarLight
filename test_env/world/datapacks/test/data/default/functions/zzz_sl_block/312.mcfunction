# ==================================================
# void default.zzz_sl_block.312()
# a.k.a default.int.sub_value.stop.1
# ==================================================
...
scoreboard players set default.int.sub_value.enabled tbms.var 0
scoreboard players set default.int.sub_value.callback tbms.var 0
