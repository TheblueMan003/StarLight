...
# a.k.a default.int.addition_variable.stop.1
# ==================================================
...
scoreboard players set default.int.addition_variable.enabled tbms.var 0
scoreboard players set default.int.addition_variable.callback tbms.var 0
