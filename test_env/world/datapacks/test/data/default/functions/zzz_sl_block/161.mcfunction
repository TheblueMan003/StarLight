# ==================================================
# void default.zzz_sl_block.161()
# a.k.a default.int.not_sub_value.stop.1
# ==================================================
...
scoreboard players set default.int.not_sub_value.enabled tbms.var 0
scoreboard players set default.int.not_sub_value.callback tbms.var 0
