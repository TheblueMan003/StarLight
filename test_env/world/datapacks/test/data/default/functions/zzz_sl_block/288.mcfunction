# ==================================================
# void default.zzz_sl_block.288()
# a.k.a default.int.eq_int.stop.1
# ==================================================
...
scoreboard players set default.int.eq_int.enabled tbms.var 0
scoreboard players set default.int.eq_int.callback tbms.var 0
