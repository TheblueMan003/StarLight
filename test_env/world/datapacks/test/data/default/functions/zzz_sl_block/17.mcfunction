...
# a.k.a default.int.tuple_unpacking_floats.stop.1
# ==================================================
...
scoreboard players set default.int.tuple_unpacking_floats.enabled tbms.var 0
scoreboard players set default.int.tuple_unpacking_floats.callback tbms.var 0
