# ==================================================
# void default.zzz_sl_block.41()
# a.k.a default.int.ternary_operator_mixed_result.stop.1
# ==================================================
...
scoreboard players set default.int.ternary_operator_mixed_result.enabled tbms.var 0
scoreboard players set default.int.ternary_operator_mixed_result.callback tbms.var 0
