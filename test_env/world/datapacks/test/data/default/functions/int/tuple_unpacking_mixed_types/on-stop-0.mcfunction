# ==================================================
# void default.int.tuple_unpacking_mixed_types.onStop-0()
# a.k.a default.int.tuple_unpacking_mixed_types.onStop
# ==================================================
...
execute unless score default.int.tuple_unpacking_mixed_types.getResult-0.a tbms.var = default.int.tuple_unpacking_mixed_types.getResult-0.a tbms.var run scoreboard players set default.int.tuple_unpacking_mixed_types.getResult-0.a tbms.var 0
execute unless score default.int.tuple_unpacking_mixed_types.getResult-0.b tbms.var = default.int.tuple_unpacking_mixed_types.getResult-0.b tbms.var run scoreboard players set default.int.tuple_unpacking_mixed_types.getResult-0.b tbms.var 0
