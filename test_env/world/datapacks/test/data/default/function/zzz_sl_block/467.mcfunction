...
execute as @e[tag=--class.default.standard.Exception.InvalidArgumentException] if score default.math.sqrt._0._0._0 tbms.var = @s default.object.__ref run scoreboard players set @s default.standard.Exception.Exception.printMessage 62734856
