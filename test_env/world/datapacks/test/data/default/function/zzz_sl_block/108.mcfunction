...
# a.k.a default.array.sugar.stop.1
# ==================================================
...
scoreboard players set default.array.sugar.enabled tbms.var 0
scoreboard players operation default.zzz_sl_mux.void___to___void.__fct__ tbms.var = default.array.sugar.callback tbms.var
function default:zzz_sl_block/107
scoreboard players set default.array.sugar.callback tbms.var 0
