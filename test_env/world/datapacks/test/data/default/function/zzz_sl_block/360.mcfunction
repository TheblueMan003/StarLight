...
# a.k.a default.standard.string.trimRight.4
# ==================================================
...
execute if score default.standard.string.trimRight.c tbms.var matches ..999 unless score default.standard.string.equals._ret tbms.var matches 0 run scoreboard players set default.standard.string.trimRight._3 tbms.var 1
