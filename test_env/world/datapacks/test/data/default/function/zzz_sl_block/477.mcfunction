...
# a.k.a default.zzz_sl_mux.void___to___string.0
# ==================================================
...
data modify storage default.zzz_sl_mux.void___to___string._ret json set string storage default.object.to-string._ret json
