...
execute unless score default.math.sqrt.iterate._0 tbms.var matches 0 run function default/zzz_sl_block/_11
execute if score default.math.sqrt.iterate._1 tbms.var matches 0 run function default/zzz_sl_block/_12
