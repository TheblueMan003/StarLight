...
execute if score default.math.root.n tbms.var = default.math.root._4 tbms.var run scoreboard players set default.math.root.ret tbms.var 1
...
execute if score default.math.root.n tbms.var > default.math.root._5 tbms.var run function default/zzz_sl_block/11
...
execute if score default.math.root.i tbms.var matches ..99 if score default.math.root.ret tbms.var matches 0 run function default/zzz_sl_block/12
