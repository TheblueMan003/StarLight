...
execute if score default.test.TestRunner.crashCount tbms.var matches 11.. run function default:zzz_sl_block/6
execute if score default.test.TestRunner.crash._0 tbms.var matches 0 run function default:test/-test-runner/run
