...
if (Compiler.isJava()){
    ...
    property x{
        lazy float get() getNBT(_ret, "Path[0]", 1000)
        lazy void set(float value) setNBT(value, "Path[0]", "double", 0.001)
    }
    property y{
        lazy float get() getNBT(_ret, "Path[1]", 1000)
        lazy void set(float value) setNBT(value, "Path[1]", "double", 0.001)
    }
    property z{
        lazy float get() getNBT(_ret, "Path[2]", 1000)
        lazy void set(float value) setNBT(value, "Path[2]", "double", 0.001)
    }
}