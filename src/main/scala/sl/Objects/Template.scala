...
class Template(context: Context, name: String, _modifier: Modifier, val block: Instruction, val parent: Template, val generics: List[String], val parentGenerics: List[Expression]) extends CObject(context, name, _modifier){
